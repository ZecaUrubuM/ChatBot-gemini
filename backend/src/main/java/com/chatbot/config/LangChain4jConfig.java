 ...
 * recebe uma instância isolada de {@link GeminiCompatibleChatMemory}.
 *
 * Essa implementação mantém o {@code SystemMessage} somente no início e
 * evicta turnos completos de function calling, para o Gemini não receber
 * {@code tool_calls} imediatamente após o system prompt.
 *
...
public class LangChain4jConfig {
    ...
    public ChatMemoryProvider chatMemoryProvider(ChatMemoryProperties properties) {
        return memoryId -> new GeminiCompatibleChatMemory(memoryId, properties.maxMessages());
    }
}
